<?php
/**
 * Test class Creator_Dirs_Only_Block_Save
 */
class Creator_Dirs_Only_Block_Save extends WP_UnitTestCase {
	...
	public function test_directories(): void {
		$this->assertContains( 'interaction/blocks/src-save/', $this->directories['plugin_directories'], 'The Array should contain block save directory' );

		$this->assertNotContains( 'interaction/blocks/src-render/', $this->directories['plugin_directories'], 'The Array should not contain render block directory' );
	}
}
